...
function IconStar() {
  return (
    <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
      <path d="M12 3l3 6 6 .9-4.5 4.3 1 6-5.5-3-5.5 3 1-6L3 9.9 9 9l3-6z" stroke="currentColor" strokeWidth="2" fill="none" />
    </svg>
  )
}
...
export default function BottomNav() {
  return (
    ...
    >
      ...
      <NavLink to="/teams" style={({ isActive }) => ({ ...baseItemStyle, color: isActive ? '#0b5' : '#444' })}>
        <IconStar />
        <span style={{ fontSize: 12 }}>Команды</span>
      </NavLink>
